...
/*    */   
			...
			/**
			 * Method added to get the number of reviews for a product based on a range(inclusive)
			 */
			public Integer getNumberOfReviewsInRange(ProductModel product, int minRange, int maxRange)
/*     */   {
/* 254 */     return CustomerReviewManager.getInstance().getNumberOfReviewsInRange((Product)getModelService().getSource(product),minRange,maxRange);
/*     */   }
/*    */ 
